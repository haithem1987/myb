...
export * from './lib/components/product-components/list-product/listProduct.component';

export * from './lib/components/product-components/create-product/createProduct.component';

export * from './lib/components/product-components/index/product.component';
